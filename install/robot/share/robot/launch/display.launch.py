...
def generate_launch_description():
    ...
    # File paths
    pathModelFile = os.path.join(get_package_share_directory(namePackage), 'mesh', 'robot.urdf')
    ...
    # Path to the empty world
    empty_world_path = os.path.join(
        get_package_share_directory(namePackage), 'worlds', 'empty.world'
    )

    # Include the Gazebo launch file from gazebo_ros with the empty world
    ...
    spawnModelNode = Node(
        ...
        arguments=['-file', os.path.join(get_package_share_directory(namePackage), 'mesh', 'robot.urdf'),
